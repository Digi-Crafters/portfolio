...
const services = [
  {
    ...
    description:
      "Custom websites and web applications built with modern technologies to establish your digital presence.",
    icon: "💻",
    features: [
  ...
  },
  {
    ...
    description:
      "Modernize your business with digital solutions that streamline operations and enhance customer experience.",
    icon: "🚀",
    features: [
      "Process automation",
  ...
  },
  {
    ...
    description:
      "Cross-platform mobile apps that help you connect with customers on the go.",
    icon: "📱",
    features: [
  ...
  },
  {
    ...
    description:
      "Boost your online visibility with targeted strategies that drive traffic and conversions.",
    icon: "📊",
    features: [
  ...
  },
  {
    ...
    description:
      "Create a cohesive digital identity that reflects your business values and attracts customers.",
    icon: "🎨",
    features: [
      "Logo & visual design",
      "Brand guidelines",
      ...
      <div className="container mx-auto max-w-6xl relative">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto text-[#e3f6fd]">
            We help businesses of all sizes establish and enhance their digital
            presence with
              ...
              <div className="p-6 relative z-10">
                ...
                <ul className="text-sm space-y-2 mb-6">
                  {service.features.map((feature, index) => (
                    <li
                      key={index}
                      className="flex items-center text-[#e3f6fd]"
                    >
        ...
        >
          ...
          <p className="mb-8 max-w-2xl mx-auto text-[#e3f6fd]">
            ...
            digital world with tailored solutions.
          </p>
