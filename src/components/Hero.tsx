  ...
  <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {[...Array(6)].map((_, i) => (
          ...
          >
            {React.createElement(services[i % services.length].icon, { size: 24 + i * 4 })}
          </motion.div>
        ))}
        ...
        <Image 
          ...
          width={400}
          height={400}
          className="absolute top-0 right-0 w-1/3 max-w-xs opacity-30 rounded-bl-3xl object-cover pointer-events-none select-none"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div className="text-center mb-12" variants={itemVariants}>
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Where innovation meets expertise. We craft digital experiences that 
              <span className="text-white font-semibold"> transform ideas into reality</span>
            </motion.p>
          </motion.div>
            ...
            <div className="flex items-center gap-4 px-8 py-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <span className={`text-lg font-semibold ${services[currentService].color}`}>
          ...
          >
            {[
              ...
              >
                <div className={`inline-flex p-3 rounded-xl bg-gradient-to-r from-white via-[#e3f6fd] to-white mb-4`}>
                  <feature.icon className="w-6 h-6 text-[#b3e0f7]" />
                </div>
                <h3 className="text-xl font-bold text-white mb-2">{feature.title}</h3>
                <p className="text-[#e3f6fd] leading-relaxed">{feature.description}</p>
